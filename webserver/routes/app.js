...
app.use(cors({
    origin: [
        "http://localhost:5173",             // Cho phép chạy Local ở nhà
        "http://localhost:3000",             // Cho phép Backend Local
        "https://vietlancerbackend.onrender.com", // Link chính Backend
        "https://vietlancerweb.onrender.com"     // 
    ],
    credentials: true, // Quan trọng: Để cho phép gửi token/cookie đăng nhập
